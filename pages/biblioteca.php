...
<head>
    ...
    <script type="text/javascript" src="../js/indexBiblioteca.js"></script>
</head>

<body class="bg-dark d-flex flex-column min-vh-100">
    <audio id="AudioH" autoplay="" src="../sounds/hover.mp3" type="audio/mpeg" allow="autoplay">
    </audio>
    <header>
        ...
        <div class="row">
            <div class="col-12 col-sm-8 col-md-8 col-lg-8">
                <div class="row align-content-center text-center">
                    <div id="j1" class="juego col-12 col-sm-12 col-md-6 col-lg-4 align-self-center">
                        <a href="../games/salto/index.php">
                            <img class="imgjuego" src="../games/salto/salto.jpg" alt="Salto">
                            <h2>Salto</h2>
                        </a>
                    </div>
                    <div id="j2" class="juego col-12 col-sm-12 col-md-6 col-lg-4 align-self-center">
                        <a href="../games/kog/index.php">
                            <img class="imgjuego" src="../games/kog/kog.jpg" alt="Labyrinth">
                            <h2>Labyrinth</h2>
                        </a>
                    </div>
                    <div id="j3" class="juego col-12 col-sm-12 col-md-6 col-lg-4 align-self-center">
                        <a href="../games/airh/index.php">
                            <img class="imgjuego" src="../games/airh/airh.jpg" alt="Air Hockey">
                            <h2>Air Hockey Alpha</h2>
                        </a>
                    </div>
                    <div id="j4" class="juego col-12 col-sm-12 col-md-6 col-lg-4 align-self-center">
                        <a href="../games/ark/index.php">
                            <img class="imgjuego" src="../games/ark/ark.jpg" alt="Arkanoid">
                            <h2>Arkanoid</h2>
                        </a>
                    </div>
                </div>
            </div>
            <div id="cajaDesc" class="col-12 col-sm-4 col-md-4 col-lg-4 border-top border-bottom descripcion align-self-center sticky-sm-top sticky-md-top sticky-lg-top">
            </div>
        </div>
