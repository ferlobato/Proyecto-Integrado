...
<head>
  ...
  <script>
    var unityInstance = UnityLoader.instantiate("unityContainer", "Build/sa.json", {
  ...
  <script>
    ...
    function inicio() {
      ...
      function selecciona() {
        ...
        var i = unityInstance.Module.asmLibraryArg._GetIntentos();
        var v = unityInstance.Module.asmLibraryArg._GetVictorias();
          ...
          if (isset($_SESSION['sesion_iniciada'])) {
            ...
            if (isset($_POST['fIntentos']) && isset($_POST['fVictorias'])) {
              ...
              if (mysqli_connect_errno()) {
                ...
                $mail = $_SESSION["mail"];
                $consulta = "SELECT try, win FROM usuarios WHERE mail='$mail'";
                ...
                if ($row != null) {
                  ...
                  $iTotales = $i + $t;
                  $wTotales = $v + $w;
                  $sql = "UPDATE usuarios set  try='$iTotales', win='$wTotales' where mail='$mail'";
                  // Update y validación
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Salto</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <p>Juego de plataforma 2.5 d</p>
            </div>
