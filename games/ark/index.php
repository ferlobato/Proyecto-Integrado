...
<head>
  ...
  <script>
    var unityInstance = UnityLoader.instantiate("unityContainer", "Build/ark.json", {
  ...
  <script>
    ...
    function inicio() {
      ...
      function selecciona() {
        ...
        var i = unityInstance.Module.asmLibraryArg._GetIntentos4();
        var v = unityInstance.Module.asmLibraryArg._GetVictorias4();
          ...
          if (isset($_SESSION['sesion_iniciada'])) {
            ...
            if (isset($_POST['fIntentos']) && isset($_POST['fVictorias'])) {
              ...
              if (mysqli_connect_errno()) {
                ...
                $mail = $_SESSION["mail"];
                $consulta = "SELECT try4, win4 FROM usuarios WHERE mail='$mail'";
                ...
                if ($row != null) {
                  ...
                  $iTotales = $i + $t;
                  $wTotales = $v + $w;
                  $sql = "UPDATE usuarios set  try4='$iTotales', win4='$wTotales' where mail='$mail'";
                  // Update y validación
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Arkanoid</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <p>Usa las teclas: izda, dcha, espacio, r</p>
            </div>
