...
<head>
  <title>In Game Web | Labyrinth</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  ...
  <script>
    var unityInstance = UnityLoader.instantiate("unityContainer", "Build/kog.json", {
  ...
  <script>
    ...
    function inicio() {
      ...
      function selecciona() {
        ...
        var i = unityInstance.Module.asmLibraryArg._GetIntentos2();
        var v = unityInstance.Module.asmLibraryArg._GetVictorias2();
          ...
          if (isset($_SESSION['sesion_iniciada'])) {
            ...
            if (isset($_POST['fIntentos']) && isset($_POST['fVictorias'])) {
              ...
              if (mysqli_connect_errno()) {
                ...
                $mail = $_SESSION["mail"];
                $consulta = "SELECT try2, win2 FROM usuarios WHERE mail='$mail'";
                ...
                if ($row != null) {
                  ...
                  $iTotales = $i + $t;
                  $wTotales = $v + $w;
                  $sql = "UPDATE usuarios set  try2='$iTotales', win2='$wTotales' where mail='$mail'";
                  // Update y validación
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Labyrinth</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <p>Encuentra la capsula dorada en un laberinto con gravedad cambiante</p>
            </div>
